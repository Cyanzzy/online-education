...
```xml
 <!-- 课程分类树型结构查询映射结果 -->
    <resultMap id="treeNodeResultMap" type="com.cyan.springcloud.model.dto.CourseCategoryTreeDto">
        <!-- 一级数据映射 -->
        ...
        <!-- 一级中包含多个二级数据：二级的集合数据 -->
        <collection property="childrenTreeNodes" ofType="com.cyan.springcloud.model.dto.CourseCategoryTreeDto">
            <!-- 二级数据映射 -->
