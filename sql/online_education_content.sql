...
Source Database       : online_education_content

Target Server Type    : MYSQL
Target Server Version : 50626
File Encoding         : 65001

Date: 2023-01-22 14:51:03
*/
...
CREATE TABLE `course_base` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='课程基本信息';
...
CREATE TABLE `course_category` (
  ...
  `is_leaf` tinyint(4) DEFAULT NULL COMMENT '是否叶子',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `course_market` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='课程营销信息';
...
CREATE TABLE `course_publish` (
  ...
  `teachplan` text COMMENT '所有课程计划，json格式',
  ...
  `price` float(10,2) DEFAULT NULL COMMENT '现价',
  `original_price` float(10,2) DEFAULT NULL COMMENT '原价',
  `valid_days` int(11) DEFAULT NULL COMMENT '课程有效期天数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='课程发布';
...
CREATE TABLE `course_teacher` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `course_id` bigint(20) DEFAULT NULL COMMENT '课程标识',
  `teacher_name` varchar(60) DEFAULT NULL COMMENT '教师标识',
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='课程-教师关系表';
...
CREATE TABLE `mq_message` (
  ...
  `returnfailure_msg` varchar(2048) DEFAULT NULL COMMENT '回复失败内容',
...
CREATE TABLE `mq_message_history` (
  ...
  `business_key2` varchar(255) DEFAULT NULL COMMENT '关联业务信息',
  `business_key3` varchar(512) DEFAULT NULL COMMENT '关联业务信息',
  `execute_num` int(10) unsigned DEFAULT NULL COMMENT '通知次数',
  `state` int(10) unsigned zerofill DEFAULT NULL COMMENT '处理状态，0:初始，1:成功，2:失败',
  `returnfailure_date` datetime DEFAULT NULL COMMENT '回复失败时间',
  `returnsuccess_date` datetime DEFAULT NULL COMMENT '回复成功时间',
  `returnfailure_msg` varchar(255) DEFAULT NULL COMMENT '回复失败内容',
  `execute_date` datetime DEFAULT NULL COMMENT '最近通知时间',
...
CREATE TABLE `teachplan` (
  ...
  `timelength` varchar(30) DEFAULT NULL COMMENT '时长，单位时:分:秒',
  `orderby` int(11) DEFAULT '0' COMMENT '排序字段',
  `course_id` bigint(20) NOT NULL COMMENT '课程标识',
  `course_pub_id` bigint(20) DEFAULT NULL COMMENT '课程发布标识',
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '状态（1正常  0删除）',
  `is_preview` char(1) DEFAULT '0' COMMENT '是否支持试学或预览（试看）',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `change_date` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=279 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='课程计划';
...
CREATE TABLE `teachplan_media` (
  ...
  `create_people` varchar(60) DEFAULT NULL COMMENT '创建人',
  `change_people` varchar(60) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `teachplan_work` (
  ...
  `course_id` bigint(20) DEFAULT NULL COMMENT '课程标识',
  `create_date` datetime DEFAULT NULL,
  `course_pub_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
