...
Source Database       : online_education_system
...
CREATE TABLE `dictionary` (
  ...
  `code` varchar(32) DEFAULT NULL COMMENT '数据字典代码',
  `item_values` text COMMENT '数据字典项--json格式\n  ',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `tb_code_unique` (`code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='数据字典';
